...
CREATE PROCEDURE insertTriple (
    IN pSub VARCHAR(700) CHARACTER SET latin1,
    IN pProp VARCHAR(700) CHARACTER SET latin1,
    IN pObj VARCHAR(10000) CHARACTER SET utf8mb4,
    IN pLang VARCHAR(255) CHARACTER SET latin1,
    IN pType VARCHAR(700) CHARACTER SET latin1
  )
